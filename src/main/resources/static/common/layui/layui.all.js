...
;!function(e) {
	...
	n.prototype.cache = o, n.prototype.define = function(e, t) {
		...
		if (t = t || "layui", e.JSON && e.JSON.parse) {
			...
			o = "object" == typeof o ? o : {
				...
				var n = {}
			} return o.value && (n[o.key] = o.value), o.remove &&
				delete n[o.key]
				, localStorage[t] = JSON.stringify(n), o.key ? n[o.key] : n
		}
...
}(window);layui.define("jquery", function(i) {
	"use strict";
	var a = layui.$,
	...
	H.prototype.config = {
		...
		"string" == typeof e && u.layHeader.find("th").each(function(i, a) {
			...
			field : r,
			sort : i
		}, "asc" === i ? c = layui.sort(p, r) : "desc" === i ? c = layui.sort(p, r, !0) : (c = layui.sort(p, d.config.indexName),
		delete u.sortKey
		), f[h.response.dataName] = c, u.renderData(f, u.page, u.count, !0), l.close(u.tipsIndex), n && layui.event.call(e, s, "sort(" + y + ")", {
			field : r,
			type : i
		})
		...
		var n = l(e.scrollElem || document),
			...
			f = function(e, o) {
				var f = a ? (o || n).height() : l(window).height(),
					m = n.scrollTop(),
					u = m + f;
				if (t.lazyimg.elem = l(r), e) c(e, f);else
